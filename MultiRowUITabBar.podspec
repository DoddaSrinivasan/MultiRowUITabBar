...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MultiRowUITabBar.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MultiRowUITabBar.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'MultiRowUITabBar' => ['MultiRowUITabBar/Assets/*.png']
  # }
